...
The API testing platform has [its own set of commands and flags](https://docs.saucelabs.com/api-testing/on-prem/ci/apif-auto/) to execute tests, incorporating tests in Git, and pushing test code.
