...
<!-- ------------------------ -->
## 1.08 Run Cypress Locally (Optional)
Duration: 0:05:00
...
b. You can quickly and easily set up the environment and tools in a Docker container to easily run tests on Sauce Labs
-->
